...
import logoBr from "../../../public/barreirinhas.png";

const ProgramSection = ({ id, title, date, program }) => (
  <div
    id={id}
    className="relative container bg-background-secondary w-[95%] z-20 sm:w-[80%] py-4 rounded-lg shadow-md mb-12"
  >
    ...
    <div className="relative z-10 flex flex-col items-center lg:px-12 text-background-white">
      <div className="md:w-auto w-full items-center md:items-start justify-center text-center md:pr-12">
        <h1 className="text-5xl font-bold font-sans whitespace-nowrap">
          {title === "São Luís" ? (
            ...
            <Image src={logoBr} alt="" width={400} height={400} />
          )}
        </h1>
